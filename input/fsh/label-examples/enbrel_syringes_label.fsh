...
* packaging.packaging.containedItem[0].amount = 1 'mL' "mL"
* packaging.packaging.containedItem[0].item.reference = Reference(Enbrel425Part1Package)
* packaging.packaging.containedItem[1].amount = 1 'mL' "mL"
* packaging.packaging.containedItem[1].item.reference = Reference(Enbrel425Part2Package)
